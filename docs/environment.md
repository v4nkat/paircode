...
| DATABASE_URL                                                 | Database tooling, future web/collaboration/worker | Server-only secret                         |
| REDIS_URL                                                    | Future web/collaboration/worker                   | Server-only secret if authenticated        |
